...
<body>
    ...
    <div class="container">
      ...
      <form class="row g-3" id="form_input">
        ...
        <div class="form-floating col-10">
          <input type="text" class="form-control" id="form-floating" name="nome" placeholder="Nome" required>
          <label for="form-floating">Nome completo: </label>
        </div>
        <!-- Sexo -->
        ...
        <div class="form-floating col-sm-9">
          <input type="email" class="form-control" id="form-floating" name="email" placeholder="email@example">
        ...
        <div class="form-floating col-sm-4">
          ...
          <label for="form-floating">Especialidade</label>
        </div>

        <div class="col-sm-12">
          <label for="medico">Profissional</label> <br />
  ...
  <script>
    const atualiza_horario = () => {
      ...
      xhr.open("GET", "busca_horarios.php?data=" + inputData.value + "&nome=" + inputNome.value, true);
    ...
    const consultaEspecialidade = (e) => {
      let xhr = new XMLHttpRequest();
      xhr.open("GET", "agendamento_cadastro.php?especialidade_medica=" + e.value, true);
      xhr.responseType = "json";
      xhr.onload = function() {
    ...
    function sendForm(form) {
      ...
      fetch("cadastro_agendamento.php", options)
        .then((response) => {
          if (!response.ok) {
