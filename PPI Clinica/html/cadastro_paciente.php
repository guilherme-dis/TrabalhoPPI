...
<body>
  ...
  <main>
    <div class="container">
      <h3 id="teste">Cadastrar Paciente</h3>
      <form class="row g-2" id="form_input">
        ...
        <div class="col-md-4">
          <div class="form-floating">
            <label for="tipos">Tipo Sanguineo:</label>
            <input type="text" class="form-control" id="tipos" name="tipos" placeholder=" " />
          </div>
        </div>
  ...
  <script>
    function sendForm(form) {
      ...
      fetch("../php/cadastro_pacientes.php", options)
        .then((response) => {
          if (!response.ok) {
